...
const handlePanelId = (e) => {
  ...
  useEffect(()=>{
     ...
     // debugger;
       // e.persist();
        ...
        const data = {
            ...
            timeFrom: scheduleInput.timeFrom,
            timeTo: scheduleInput.timeTo,         
        }

        console.log(data);

       // debugger;
        axios.post(Schedule_Baseurl + "/AddSchedule", data).then(res => {
         // debugger;
            // if(res?.data?.status === 200){
                console.log(res.data);
    ...
    {/* <div class="row"> */}
        ...
        <form className="addformjob" onSubmit={submitSchedule} encType="multipart/form-data">

            <h2><strong>Add Interview Schedule</strong></h2>
    ...
    {/* </div> */}
            ...
            <button id="jobb" className="btn btn-success" type="submit" onClick={()=>submitSchedule}>Create</button>
            <br></br>
            <br></br>
